...
#       get positions_url, headers: valid_headers, as: :json
...
#               params: { position: new_attributes }, headers: valid_headers, as: :json
#         position.reload
...
#       position = Position.create! valid_attributes
#       expect {
#         delete position_url(position), headers: valid_headers, as: :json
#       }.to change(Position, :count).by(-1)
#     end
#   end
# end
